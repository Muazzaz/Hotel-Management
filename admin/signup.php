      ...
      <div class="container">
        ...
        >
          <div class="col-md-10 text-center" data-aos="fade">
            <h1 class="heading mb-3">SignUP</h1>
    ...
    <section class="section contact-section" data-aos="fade-up" data-aos-delay="100" id="next">
      ...
      <div class="row">
          ...
          <div class="row">
              ...
              <a href="./signin.php" class="btnup_already"> Already Admin</a> 
                 <br>
                 <br>
             ...
             <div class="row" data-aos="fade-up" data-aos-delay="100"> 
                <div class="col-md-12 form-group">
                  <label class="text-black font-weight-bold" for="phone"
                    >Mobile No</label
                  >
                  <input type="tel" id="phone" class="form-control" pattern="[0-9]{11}" placeholder="Enter Your 11 Digit Phone no" required/>
                </div>
            </div>
              ...
              <div class="row" data-aos="fade-up" data-aos-delay="100">
                <div class="col-md-12 form-group">
                  ...
                  <input type="email" id="email" class="form-control" placeholder="Enter valid Email Address" required/>
                </div>
              </div>

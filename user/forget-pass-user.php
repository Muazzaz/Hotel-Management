              ...
              <div class="row" data-aos="fade-up" data-aos-delay="100">
               ...
               <div class="row" data-aos="fade-up" data-aos-delay="100">
                <div class="col-md-6 form-group">
                  <input
                    type="submit" value="Request" name="submit" class="btnup4 text-black py-3 px-5 font-weight-bold"
                  />
                </div>
...
<?php 
      ...
      if(isset($_POST['submit']))
      {
        ...
        $sql="SELECT * FROM admin WHERE gmail='$username' ;"; //;AND admin.password='$pass';"
        ...
        if($res==TRUE)
        {
          ...
          if($count==1)
          {
              ...
              {
                $_SESSION['login']= '<h5 class="text-success text-center">Welcome </h5><br>';
                header('location:'.url.'admin/manage-admin.php');
                $_SESSION['username']=$username;
               
              }
              else{
                $_SESSION['login']= '<h5 class="text-danger text-center">Username or Password Incorrect</h5><br>';
                header('location:'.url.'admin/signin.php');
              }
                
          }
          else{
            $_SESSION['login']= '<h5 class="text-danger text-center">User Not Found</h5><br>';
            header('location:'.url.'admin/signin.php');
          }
        }

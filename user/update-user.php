      ...
      <div class="row justify-content-center">
          <div class="col-md-6 " data-aos="fade-up" data-aos-delay="500">
            ...
            <div class="row">
              ...
              <h1 class="heading mb-3 text-login font-weight-bold">Update Admin</h1>
                 <br>
              </div>
            </div>
            <?php
                  ...
                  if($res==true)
                  {
                    ...
                    echo '<h5 class="text-success text-center">failed</h5>';
                  }
            ...
            <div class="row" data-aos="fade-up" data-aos-delay="100">
                <div class="col-md-12 form-group" >
                  <label class="text-login font-weight-bold" for="name"
                    >Full Name</label
                  >
                  <input type="text" value="<?php echo $Fullname?>" name="fullname" id="name" class="form-control text-white bg-dark" placeholder="Enter your Full Name" required/>
                </div>
            </div>
             ...
             <div class="row" data-aos="fade-up" data-aos-delay="100"> 
                <div class="col-md-12 form-group">
                  <label class="text-login font-weight-bold" for="phone"
                    >Mobile No</label
                  >
                  <input type="tel" value="<?php echo $Mobile?>" name="mobile" id="phone"  class="form-control text-white bg-dark" pattern="[0-9]{11}" placeholder="Enter Your 11 Digit Phone no" required/>
                </div>
             </div>
              ...
              <div class="row" data-aos="fade-up" data-aos-delay="100">
                <div class="col-md-12 form-group">
                  <label class="text-login font-weight-bold" for="email">
                    ...
                    <input type="email" id="email" value="<?php echo $Email?>" name="email" class="form-control text-white bg-dark" placeholder="Enter valid Email Address" required/>
                </div>
              </div>
              <div class="row" data-aos="fade-up" data-aos-delay="100">
                <div class="col-md-12 form-group">
                    <input type="hidden" value="<?php echo $ID2?>" name="id" class="form-control text-white bg-dark" />
                </div>
              </div>
...
if(isset($_POST['submit']))
{
   ...
   $sql="UPDATE admin
   SET name = '$Fullname', mobile = '$Mobile', gmail= '$Gmail'
   WHERE id='$id';";
  ...
  if ($res==TRUE)
  {
    $_SESSION['update']= '<h4 class="text-success text-center">Admin Updated Successfully</h4><br>';
    header('location:'.url.'admin/manage-admin.php');
  }

  else{
    $_SESSION['update']= '<h4 class="text-danger text-center">Failed Try Again</h4><br>';
    header('location:'.url.'admin/manage-admin.php');
  }
